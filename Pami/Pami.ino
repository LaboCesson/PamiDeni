...
void onEdge() {
  ...
  char distance = 0; // OBTENSION DE LA DISTANCE AVEC LE ULTRASON ICI!

  if (distance >= 5){ // Hauteur réelle: 55mm (5.5cm). Changer si besoin pour correspondre aux millimètres!!
    pami.moteur.moteurGauche(0);
    pami.moteur.moteurDroit(0);
